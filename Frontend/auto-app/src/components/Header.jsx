      ...
      <header>
        <div id="header" className="header">
          <div className="logo">
            <Link to="/">
              <img
                src="https://buimagenes.s3.us-east-2.amazonaws.com/Logo/logo1DB.png"
                alt="logo"
                className="logo-img"
              />
            </Link>
          ...
          {width > 480 ? (
            <>
              <div className="inputs-header-logged">
                {nombreCompleto.rol !== 2 || props.reservas || (
                ...
                {nombreCompleto.rol !== 1 || props.administracion || (
              ...
              <div className="user-info">
                ...
                <div className="user">
                  ...
                  <p className="saludo">
                    ...
                    <span className="colorUser"> {usuario()} </span>
                  </p>
                </div>
              </div>
            </>
            ...
            <>
              <div className="inputs-header">
                <i className="opciones" id="opciones" onClick={toggleNav}>
                  {menu}
                </i>
              </div>
              <div id="mySidenav " className={show}>
                <div className="opciones" id="opciones">
                  ...
                  <div className="opciones-header-burger" id="opciones-header">
                    <div className="avatar-burger">
                      <span className="iniciales-avatar-burger">
                        {" "}
                        {iniciales()}{" "}
                      </span>
                    </div>
                    <div className="user">
                      <p className="saludo">
                        {" "}
                        <span className="hola-burger">Hola,</span>
                        <span className="colorUser-burger"> {usuario()} </span>
                      </p>
                    </div>
                ...
                <div className="opciones-links-burger" id="opciones-links">
                  <p>
                    ¿Deseas{" "}
                    <span onClick={handlerClose} className="color-links">
                      cerrar sesión
                    </span>
                    ?
                  </p>
