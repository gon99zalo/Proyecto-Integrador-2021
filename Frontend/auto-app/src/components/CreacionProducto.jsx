        ...
        <form className="form-crear-auto" action="">
          <div className="inputs-crear-auto">
            ...
            <label htmlFor="categoria">Categoria</label>
              ...
              {categorias.map((categoria)=><option>{categoria.titulo}</option>)}
              </select>


              <label htmlFor="ciudad">Ciudad</label>
              <select defaultValue="Ciudad" name="ciudad" id="ciudad" required> 
              <option value="Ciudad" disabled>Ciudad</option>
              {ciudades.map((ciudad)=><option>{ciudad.nombre}</option>)}
              </select>
            </div>
            </div>
